        ...
        <ErrorBoundary noop onError={() => {
            ...
            >
                <div>
                    ...
                    <div style={{ padding: "1em" }}>
                        <Paragraph>
                            This Badge is a special perk for Vault (Not Vencord) Donors
                        </Paragraph>
                        <Paragraph className={Margins.top20}>
                            Please consider supporting the development of Vault by becoming a donor. It would mean a lot! :3
                        </Paragraph>
                    </div>
                </div>
                <div>
            ...
            >
                <div>
                    ...
                    <div className="vc-translate-modal-paragraph">
                        <Paragraph>
                            Awarded to contributors who expand Vault’s language support by translating content for the community.
                        </Paragraph>
                    </div>
                </div>
                <div>
