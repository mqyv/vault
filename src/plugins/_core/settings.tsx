...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Vault settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Vault ${gitHashShort}${getVersionInfo()}`];
