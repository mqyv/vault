...
function EquicordIcon() {
    return <img src="https://equicord.org/assets/favicon.png" alt="Vault" style={ICON_STYLE} />;
}
...
const cloudBackendOptions = [
    { label: "Vault Cloud", value: "https://cloud.equicord.org/" },
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Vault's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                We use our own <Link href="https://github.com/Equicord/Equicloud">cloud backend</Link> with enhanced features.
                View our <Link href="https://equicord.org/cloud/policy">privacy policy</Link> to see what we store and how we use your data.
                It is BSD 3.0 licensed, so you can self-host if preferred.
            </Notice.Info>
            ...
            <Paragraph className={Margins.bottom16}>
                Choose which cloud backend to use for storing your settings. You can switch between Vault's and Vencord's cloud services, or use a self-hosted instance.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your Vault settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
